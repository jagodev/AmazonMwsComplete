...
/**
 * MWSCustomerService_Client is an implementation of MWSCustomerService
 *
 */
class MWSCustomerService_Client implements MWSCustomerService_Interface
{
    ...
    private  $_config = array ('ServiceURL' => null,
                               'UserAgent' => 'MWSCustomerService PHP5 Library',
                               'SignatureVersion' => 2,
    ...
    /**
     * Convert GetCustomersByCustomerIdRequest to name value pairs
     */
    private function _convertGetCustomersByCustomerId($request) {
        ...
        if ($request->isSetCustomerIdList()) {
            $parameters['CustomerIdList'] =  $request->getCustomerIdList();
        }
    ...
    /**
     * Convert GetCustomersForCustomerIdRequest to name value pairs
     */
    private function _convertGetCustomersForCustomerId($request) {
    ...
    /**
     * Convert ListCustomersRequest to name value pairs
     */
    private function _convertListCustomers($request) {
        ...
        if ($request->isSetDateRangeType()) {
            $parameters['DateRangeType'] =  $request->getDateRangeType();
        }
    ...
    /**
     * Convert ListCustomersByNextTokenRequest to name value pairs
     */
    private function _convertListCustomersByNextToken($request) {
   ...
   private function collapseWhitespace($s) {
    ...
    private function _invoke(array $parameters)
    {
        try {
            if (empty($this->_config['ServiceURL'])) {
                ...
                throw new MWSCustomerService_Exception(
    ...
    private function _reportAnyErrors($responseBody, $status, $responseHeaderMetadata, Exception $e =  null)
    {
        ...
        require_once (dirname(__FILE__) . '/Exception.php');
        return new MWSCustomerService_Exception($exProps);
    }
    ...
    private function _httpPost(array $parameters)
    {
        ...
        if($response === false) {
            ...
            curl_close($ch);
            throw new MWSCustomerService_Exception($exProps);
        }
    ...
    */
    private function _extractResponseHeaderMetadata($rawHeaders){
        ...
        return new MWSCustomerService_Model_ResponseHeaderMetadata(
